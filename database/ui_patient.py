...
class Ui_Patient(object):
    def setupUi(self, Patient):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(0, 10, 421, 364))
        ...
        self.grid_layout.addWidget(self.label_6, 3, 0, 1, 2)
        ...
        self.grid_layout.addWidget(self.tx_weight, 3, 2, 1, 1)
        ...
        self.grid_layout.addWidget(self.label, 1, 1, 1, 1)
        self.tx_notes = QtGui.QPlainTextEdit(self.layoutWidget)
        self.tx_notes.setMaximumSize(QtCore.QSize(50000, 16777215))
        self.tx_notes.setObjectName(_fromUtf8("tx_notes"))
        self.grid_layout.addWidget(self.tx_notes, 4, 0, 1, 6)
        ...
        self.grid_layout.addWidget(self.label_4, 2, 4, 1, 1)
        ...
        self.grid_layout.addWidget(self.dt_birth_date, 2, 2, 1, 2)
        ...
        Patient.setTabOrder(self.tx_id, self.tx_name)
        ...
        Patient.setTabOrder(self.tx_weight, self.cb_sex)
        Patient.setTabOrder(self.cb_sex, self.tx_notes)
